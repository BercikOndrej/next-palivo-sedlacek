...
export const formSchema = z.object({
  ...
  street: z.string().min(1, { message: 'pole je povinné'}).max(100, { message: 'pole může obsahovat maximálně 100 znaků' }),
  city: z.string().min(1, { message: 'pole je povinné'}).max(100, { message: 'pole může obsahovat maximálně 100 znaků' }),
