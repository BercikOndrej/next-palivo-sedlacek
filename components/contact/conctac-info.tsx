...
const commonStyle = "group flex w-max items-center gap-8 text-heading transition-all duration-300 hover:gap-12 hover:text-primary";
const iconStyle = "h-8 w-8 transition-transform duration-300 group-hover:scale-110 md:h-12 md:w-12";
const textStyle = "text-l font-semibold transition-colors duration-300 group-hover:text-primary md:text-xl";
